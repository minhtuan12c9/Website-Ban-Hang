            ...
            <div class="conten">
                ...
                <div class="conten mid">
                    ...
                    <div class="conten mid main">
                        <?php 
                            $sql = "select * from sanpham where danhmuc='ban_phim'";
                        ...
                        <!-- product item -->
                            ...
                            <a href="../../chitietsanpham/chitiet.php?id=<?php echo $row['id'];?>">
                                <div class="conten mid main unit">
                                    <div class="conten mid main unit hinh">
                                        <img src="../../anhsanpham/<?php echo $row['anhsanpham'];?>">
                                    </div>
